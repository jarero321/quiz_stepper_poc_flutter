...
class ResultViewModel extends ChangeNotifier {
  ...
  static const Map<String, TravelerProfile> _profiles = {
    'mochilero': TravelerProfile(
      ...
      description:
          'Viajás ligero, buscás lo imprevisto y medís el viaje en historias, no en estrellas de hotel.',
    ...
    'resort': TravelerProfile(
      key: 'resort',
      title: 'Descansador',
      tagline: 'Ya trabajo mucho — que me atiendan.',
      description:
          'Querés desconectar sin decisiones: piscina, tragos, buffet y que el protector solar te llegue a la reposera.',
    ...
    'cultural': TravelerProfile(
      key: 'cultural',
      title: 'Curioso Cultural',
      tagline: 'Cada ciudad es una clase magistral.',
      description:
          'Museos, barrios antiguos, caminatas con audioguía. Volvés sabiendo más de lo que llevabas.',
    ...
    'gastronomico': TravelerProfile(
      ...
      description:
          'Mercados, bodegas, tacos al pastor, omakase, queso de cabra. El viaje pasa por el paladar.',
